...
class AlienInvasion():
    ...
    def __init__(self):
        ...
        # Make the easy, hard, and medium buttons.
        self.easy_button = Button(self, self.settings.screen_width// 2 - 100, 100, "Easy")
        self.medium_button = Button(self, self.settings.screen_width// 2 - 100,200, "Medium")
        self.hard_button = Button(self, self.settings.screen_width// 2 - 100, 300, "Hard")
