...
class AlienInvasion():
    ...
    def __init__(self):
        ...
        # Create an instance to store sounds.
        self.sounds = Sounds(self)

        # Create an instance to store ship, bullet, and alien sprites.
        self.ship = Ship(self)
    ...
    def _create_alien(self, alien_number, row_number):
        ...
        alien.rect.y = 3*alien_height + 2 * alien.rect.height * row_number
